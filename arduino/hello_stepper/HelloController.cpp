...
void handleNewRPC()
{
  ...
  switch(rpc_in[0])
  {
    ...
    case RPC_SET_NEXT_TRAJECTORY_SEG: 
          ...
          memcpy(traj_seg_reply.error_message, trajectory_manager.seg_load_error_message,SIZE_TRAJ_ERROR_MSG);
          traj_seg_reply.error_message[SIZE_TRAJ_ERROR_MSG-1]=0;//terminate string

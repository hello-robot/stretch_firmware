...
////////////////////////SerialExt///////////////////////////////////////
/*
 * This will get called everytime a new command comes down via RPC
 * It can pass the new command data to the serial device
 * It can then read data back from the serial device
 * , and then return this data back to Stretch body
 * Currently setup as 10 floats (40 bytes).
 * The data packet can be modified in Common.h
 */
void serial_comms()
{
